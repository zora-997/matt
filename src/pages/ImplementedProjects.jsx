...
function ImplementedProjects() {
 ...
 let images = [
  ...
  return (
    <div  id='projects' className="flex flex-col max-w-[1820px] m-auto items-center justify-center mt-10 pb-10 text-center pr-4 pl-4 sm:mb-56 mb-20">
      ...
      >{texts.our_implemented_projects}</h1>
         <hr
...
<div  className='flex justify-center items-cente object-cover w-full h-56 '>
        <img src={item.src} alt={item.alt} onClick={() =>  setIsOpen(true,i)} className='flex  justify-center items-cente object-cover w-full h-56'/>  
        </div>
